...
public abstract class AbstractMinaServerPropertiesInjector implements ServerPropertiesInjector {

    protected LoggingFilter getLoggingFilter(@SuppressWarnings("SameParameterValue") LogLevel level) {
