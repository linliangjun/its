...
class NettyTcpServerTest extends AbstractServerTest {
    ...
    static {
        ...
        properties.put("bossThreads", 1);
        properties.put("workerThreads", 4);
        properties.put("channelInitializer", new ChannelInitializer<SocketChannel>() {
            @Override
    ...
    public NettyTcpServerTest() {
        super(new NettyTcpServer(), properties);
    }
